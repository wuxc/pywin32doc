...
A windows listbox control.  Encapsulates an MFC __CListBox__ class.  Derived from a[PyCControl](#pyccontrol)object.
...
## [PyCListBox](#pyclistbox).SelItemRange
 ...
 __SelItemRange( *bSel*  *, start*  *, end* __ )
...
## [PyCListBox](#pyclistbox).SetCaretIndex
 ...
 __SetCaretIndex( *index*  *, bScroll* __ )
