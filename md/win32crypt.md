...
Usually should be X509\_ASN\_ENCODING combined with PKCS\_7\_ASN\_ENCODING
  ...
  -  *Para\=None* : object
     ...
     **PyCERT\_SYSTEM\_STORE\_RELOCATE\_PARA** , or data specific to provider
